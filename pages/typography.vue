<template>
  <section>
    ...
    <br />
    <img
      src="https://d2w9rnfcy7mm78.cloudfront.net/11612785/original_85268c167ded8520ee94570e3685062f.jpg?1618591565?bc=0"
      alt=""
      style="width:100%;"
    />

    <!-- <Grid align-items="end">
      <Column v-for="num in 6" :key="num" :xs="2">
        <Type :tag="`h${num}`" :size="num">Aa</Type>
      </Column>
    </Grid> -->
  </section>
</template>
